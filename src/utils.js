    ...
    function parseCommand(command, type) {       
     ...
     try {
      if(command.startsWith("g40cli")){
        ...
        const rb = {
         ...
         "disconnect_status": "P"
          ...
          let res = await axios.post('http://35.188.41.6:8001/api/disconnectNE/', {...rb})
          ...
          let res = await axios.post('http://35.188.41.6:8001/api/connectNE/', {...rb})
          return res;
          ...
          let res = await axios.post('http://35.188.41.6:8001/api/sendrcv/?Content-Type=application/json', {...requestBody})
          return res;
        }
      ...
      return res;
        ...
        let res = await axios.post('http://35.188.41.6:8001/api/retDataToTab/?Content-Type=application/json', {...requestBody})
        ...
        if(getFromLS){
          ...
          let res = await axios.post("http://35.188.41.6:8001/api/compare_pair/?Content-Type=application/json", {... compare_pair_payload})
          return res;
        }
     } else {
