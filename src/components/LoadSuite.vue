  ...
  <table class="loadsuite-table">
    ...
    <tbody>
      <tr v-for="(suite,row) in loadSuiteData" :key="row" >
        ...
        <td>
          <button class="btn btn-primary" :disabled="isRunSuitClicked" @click="runCommand(suite)" style="background-color: #f3f6f9;"> <i class="fa fa-play" aria-hidden="true" style="color: #3699ff; background-color: #f3f6f9;"></i></button>
