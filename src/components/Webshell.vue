...
export default {
  ...
  methods: {
    reNew() {
      setInterval(() =>{
        axios.get("http://35.188.41.6:8001/api/logs/?Content-Type=application/json").then(
      (response) =>{
      ...
      if(command.startsWith("g40cli")){
          ...
          const rb = {
           ...
           "disconnect_status": "P"
            ...
            axios.post('http://35.188.41.6:8001/api/disconnectNE/', {...rb})
            .then(res => {
            ...
            //console.log("Request body:: ", rb);
            axios.post('http://35.188.41.6:8001/api/connectNE/', {...rb})
            .then(res => {
           ...
           //console.log("Parsed Data::: ", data);
            ...
            axios.post('http://35.188.41.6:8001/api/sendrcv/?Content-Type=application/json', {...requestBody})
            .then(res => {
              terminal.write(res.data);
              return res.data;
            })
        ...
        axios.post('http://35.188.41.6:8001/api/retDataToTab/?Content-Type=application/json', {...requestBody})
        .then(res => {
        ...
        if(getFromLS){
          ...
          axios.post("http://35.188.41.6:8001/api/compare_pair/?Content-Type=application/json", {... compare_pair_payload})
          .then(res => {
            //console.log("Res:::: ", res);
            terminal.write(res.data);
            terminal.write('\n');
