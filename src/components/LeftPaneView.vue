...
export default {
    ...
    async fetchFileDetails(node,parentLabel){
        try{
          ...
          if(parentLabel === 'g30'){
            apiUrl = "http://35.188.41.6:8001/api/latest-file-versions/?Content-Type=application/json&test_suite_uuid="+node.label+"&userid_uuid=e5ed4652-96ea-49ba-b3bb-f84fd7&folder=g30/cli";

          }else if(parentLabel === 'g40'){
            apiUrl = "http://35.188.41.6:8001/api/latest-file-versions/?Content-Type=application/json&test_suite_uuid="+node.label+"&userid_uuid=e5ed4652-96ea-49ba-b3bb-f84fd7&folder=g40/cli";
      ...
      async getLeftPane(){
       await axios.get('http://35.188.41.6:8001/api/files/?Content-Type=application/json')
        .then(async res => {
